// src/pages/tutor/TutorEventsPage.jsx
...
const TutorEventsPage = () => {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        const res = await axiosInstance.get("/admin/events/audience?audience=tutors", {
...
export default TutorEventsPage;